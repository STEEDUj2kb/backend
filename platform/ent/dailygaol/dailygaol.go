...
const (
	// Label holds the string label denoting the dailygaol type in the database.
	Label = "daily_gaol"
	...
	EdgeWgoal = "wgoal"
	// Table holds the table name of the dailygaol in the database.
	Table = "daily_gaols"
	...
	// WgoalInverseTable is the table name for the WeeklyGaol entity.
...
// Columns holds all SQL columns for dailygaol fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
